...
const Footer = () => {
    ...
    const [headerData] = React.useState([{ id: 1, link: '/', nav_en: 'Buyers', nav_ru: 'Покупателям', nav_uz: 'Xaridorlar', }, { id: 2, link: '/', nav_en: 'Trust us', nav_ru: 'Нам доверяют', nav_uz: 'bizga ishonganlar', }, { id: 3, link: '/video-reviews', nav_en: 'VIDEO REVIEWS', nav_ru: 'ВИДЕО ОБЗОРЫ', nav_uz: 'VIDEO SHARHLAR', }, { id: 4, link: '/contact', nav_en: 'CONTACTS', nav_ru: 'КОНТАКТЫ', nav_uz: 'KONTAKTLAR', }]);
