...
import Detail from '@/app/components/screens/videoreviews/detail/Detail';

const ReviewesDetail = () => {
    ...
    return (
        <>
            <Head>
                ...
                <meta property="og:title" content="ASA.Loft | Video-Reviews" /> // Название страницы
